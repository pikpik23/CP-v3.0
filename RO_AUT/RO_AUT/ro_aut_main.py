...
#
#   change working directory to RO_AUT folder
...
###########################################################
#
# NOTE: you NEED a api token and user credentials
#
# STEPS:
#   1. Visit site below
...
#   4. Rename the downloaded file to "sheetsToken.json"
#   5. Place in the RO_AUT folder
#   6. Run Script
#
###########################################################
###########################################################
...
###########################################################
###########################################################
#	     	EDIT VARIABLES BELOW "CAREFULLY" 			  #
###########################################################
###########################################################

# SHEET ID CODES 
# (THIS IS THE CODE OF THE RO AUTOMATION DATA SPREADSHEET)
# Make a copy of mine before my account gets shutdown by IT
# Then update the ID below (The ID is in the URL)
...
# Create connection to master TP input 
# (Careful you have write access)
